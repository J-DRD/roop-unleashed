...
class Settings:
    ...
    def load(self):
        ...
        self.output_image_format = self.default_get(data, 'output_image_format', 'jpg')
        ...
        self.video_quality = self.default_get(data, 'video_quality', 12)
        ...
        self.memory_limit = self.default_get(data, 'memory_limit', 8)
        ...
        self.use_os_temp_folder = self.default_get(data, 'use_os_temp_folder', True)
